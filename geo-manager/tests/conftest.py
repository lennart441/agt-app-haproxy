...
def clean_env(monkeypatch):
    ...
    for key in (
        "NODE_NAME", "NODE_PRIO", "MESH_NODES", "ANCHOR_IPS", "GEO_ALLOWED_COUNTRIES", "GEO_SOURCE_URL",
        "GEO_SOURCE_IPV6_URL", "GEO_BLOCKS_IPV6_URL", "MAP_DIR", "HAPROXY_CFG_PATH", "HAPROXY_SOCKET",
